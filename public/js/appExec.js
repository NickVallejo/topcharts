...
async function list_load() {
  try {
    await new Promise((resolve, reject) => {
      ...
      req.open("GET", "http://143.198.119.208:4001/my-lists", true)
...
function sugg_load(savedNames) {
  ...
  sugg_loader.open(
    "GET",
    `http://143.198.119.208:4001/similar-artists?artistNames=${encodeURIComponent(JSON.stringify(savedNames))}`, 
    true
  )
